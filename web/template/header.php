...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="<?= htmlspecialchars($LANG, ENT_QUOTES) ?>" lang="<?= htmlspecialchars($LANG, ENT_QUOTES) ?>">
    <head>
        <title>Jackson College Pathways <?php if ($title != "") { print " - " . htmlspecialchars($title); } ?></title>
        ...
        <meta name="description" content="JC Pathways Database" />
			...
			<link rel='stylesheet' id='bootstrapover' href='css/bootstrap/custombs.css' type='text/css'>
    ...
    <div class="banner">
		<a href="http://www.jccmi.edu">
			<img class="logo" src="images/Jc_Logo.png">
		</a>
    </div>
	</div>